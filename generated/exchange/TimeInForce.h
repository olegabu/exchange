...
#ifndef _EXCHANGE_TIMEINFORCE_CXX_H_
#define _EXCHANGE_TIMEINFORCE_CXX_H_
...
public:
    enum Value
    {
        ...
        ImmediateOrCancel = static_cast<std::uint8_t>(3),
    ...
    static TimeInForce::Value get(const std::uint8_t value)
    {
        switch (value)
        {
            ...
            case static_cast<std::uint8_t>(3): return ImmediateOrCancel;
    ...
    static const char *c_str(const TimeInForce::Value value)
    {
        switch (value)
        {
            ...
            case ImmediateOrCancel: return "ImmediateOrCancel";
