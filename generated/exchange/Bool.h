...
#ifndef _EXCHANGE_BOOL_CXX_H_
#define _EXCHANGE_BOOL_CXX_H_
...
public:
    ...
    static const char *c_str(const Bool::Value value)
    {
        switch (value)
        {
    ...
    friend std::basic_ostream<CharT, Traits> & operator << (
        std::basic_ostream<CharT, Traits> &os, Bool::Value m)
    {
        return os << Bool::c_str(m);
    }
};
